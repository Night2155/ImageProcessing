...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Set_Threshold_Value_Slider.setGeometry(QtCore.QRect(1010, 230, 160, 22))
        self.Set_Threshold_Value_Slider.setMaximum(255)
        self.Set_Threshold_Value_Slider.setProperty("value", 0)
        ...
        self.Text_label.setGeometry(QtCore.QRect(1000, 160, 121, 31))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(16)
        ...
        self.Text_label_0.setGeometry(QtCore.QRect(1000, 200, 21, 21))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(16)
        ...
        self.Text_label_255.setGeometry(QtCore.QRect(1150, 200, 31, 21))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(16)
        ...
        self.Image_Info_label.setGeometry(QtCore.QRect(170, 790, 281, 41))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(16)
        self.Image_Info_label.setFont(font)
        self.Image_Info_label.setObjectName("Image_Info_label")
        self.Set_Thershold_Value_lineEdit = QtWidgets.QLineEdit(self.centralwidget)
        self.Set_Thershold_Value_lineEdit.setGeometry(QtCore.QRect(1120, 170, 81, 20))
        self.Set_Thershold_Value_lineEdit.setMaxLength(255)
        self.Set_Thershold_Value_lineEdit.setObjectName("Set_Thershold_Value_lineEdit")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(_translate("MainWindow", "直方圖"))
